...
const Index = () => {
  ...
  const handleClaim = () => setStep("claim");
  ...
  return (
    <div className="min-h-screen casino-gradient relative overflow-x-hidden">
      ...
      <section className="flex flex-col items-center px-4 pt-8 pb-6 text-center">
        ...
        {step === "result" && (
          <div className="flex flex-col items-center gap-4 animate-in fade-in-0 zoom-in-95 duration-500">
            ...
            <Button
              onClick={handleClaim}
              className="mt-4 px-8 py-6 text-lg font-extrabold rounded-full gold-gradient text-primary-foreground pulse-glow uppercase tracking-wide"
            >
              🎁 Reclamar mi bono
            </Button>
          </div>
          ...
          <div className="w-full max-w-sm animate-in slide-in-from-bottom-4 duration-500">
            <div className="bg-card/80 backdrop-blur rounded-2xl p-6 gold-border">
              ...
              <div className="flex items-center justify-center gap-2 mb-5">
                ...
                <span className="font-mono font-bold text-casino-gold text-sm bg-muted/60 px-2 py-0.5 rounded">
      ...
      <a
        ...
        className="fixed bottom-4 left-4 right-4 z-40 flex items-center justify-center gap-2 py-4 rounded-full bg-[hsl(142,70%,40%)] text-white font-bold text-base shadow-lg active:scale-95 transition-transform"
      >
