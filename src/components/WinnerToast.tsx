...
const WinnerToast: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-20 left-4 z-50 max-w-[280px] animate-in slide-in-from-left-5 fade-in-0 duration-300">
      <div className="bg-card/95 border border-border rounded-xl p-3 shadow-lg relative overflow-hidden">
        <span className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full animate-[shimmer_2.5s_ease-in-out_infinite] pointer-events-none" />
